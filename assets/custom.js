 ...
 * `#Details-menu-drawer-container` so `custom.css` positions `.menu-drawer` flush under the header.
 */
...
/**
 * Bottom edge of header chrome in viewport coordinates; prefer visible `.header__row` rects.
 */
